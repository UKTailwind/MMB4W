...
extern int turtle_init_not_done;
extern int    main_turtle_poly_vertex_count;       // polygon vertex count
extern MMFLOAT* main_turtle_polyX; // polygon vertex x-coords
extern MMFLOAT* main_turtle_polyY; // polygon vertex y-coords
extern int    main_field_width;           // size in pixels
